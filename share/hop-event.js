/*=====================================================================*/
/*    serrano/prgm/project/hop/3.0.x/share/hop-event.js                */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Thu Sep 20 07:19:56 2007                          */
/*    Last change :  Thu Sep  3 16:06:07 2015 (serrano)                */
...
function hop_servevt_envelope_parse( val, xhr ) {
   ...
   if( m != null ) {
	 ...
	 if( k === "i" ) {
	    ...
	    if( t ) {
	       console.log( "text=", text, " t=", t );
	       alert( "t1=" + hop_url_encoded_to_obj( t[ 1 ] ) );
