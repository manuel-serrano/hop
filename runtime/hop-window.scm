;*=====================================================================*/
;*    serrano/prgm/project/hop/runtime/hop-window.scm                  */
;*    -------------------------------------------------------------    */
;*    Author      :  Erick Gallesio                                    */
;*    Creation    :  Wed Mar  1 12:23:29 2006                          */
;*    Last change :  Thu Apr 27 08:13:14 2006 (serrano)                */
;*    -------------------------------------------------------------    */
   ...
   (let* ((id         (xml-make-id id 'HOP-WINDOW))
	 ...
	 (<TABLE>
	    ...
	    (<TR>	; Line #1
		  ...
		  (<TABLE>
		     :class "hop-float-handle" :id handle-id :width "100%"
