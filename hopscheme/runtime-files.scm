...
;; This file has been commented out by MS on Oct, 14 2006. This file
;; is now useless because the inclusion of the Hop runtime system is
;; now handled by the implementation of the <HEAD> markup. The list
;; of the JS files implementing the Hop RTS are defined in
;; etc/configure.scm.in (see also the configure script).
