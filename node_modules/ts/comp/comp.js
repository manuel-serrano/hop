...
/*    Last change :  Tue Feb 15 09:35:17 2022 (serrano)                */
...
function J2SFunThis(node, env, scope, thisp, body) {
   return new hopc.J2SFun(J2SLoc(node, env), // loc
      ...
      node.type ? J2SType(node.type) : J2SSymbol("unknown"), // rutype
      undefined, // rrange
...
function main() {
   ...
   const prog = ts.createProgram([src], {noEmit: !emitjs, __proto__: options});
