...
/*    Last change :  Wed Jun  8 07:15:06 2022 (serrano)                */
...
function J2SPostPrefix(node, env, scope, ctor) {
   ...
   return new ctor(J2SLoc(node, env), // loc
      ...
      J2SExpr(node.operand, env, scope), // rhs
      op); // op
}
...
function J2SDeclClass(node, env, scope) {
   ...
   const binder = node.decorators?.find(e => e?.expression?.EscapeText === "sealed") ? "record" : "class" || "class";
