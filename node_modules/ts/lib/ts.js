...
/*    Last change :  Thu Apr 29 08:25:11 2021 (serrano)                */
...
exports[ Symbol.compiler ] = (file, options) => {
   ...
   const cmd = `sh -c "${node} ${ts} ${file} ${target} ${main} ${config.modulesDir} 2>&1"`;

   if( config.debug > 0 || (process.env.HOPTRACE && process.env.HOPTRACE.match( "nodejs:compile" ) ) ) {
