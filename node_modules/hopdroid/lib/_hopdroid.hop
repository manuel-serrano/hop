...
;*    Last change :  Thu May 21 07:22:39 2020 (serrano)                */
				   ...
				   (when (phone? this)
					 ...
					 (cond
					    ((js-array? frequency)
						 ...
						 (phone-vibrate data (jsarray->vector frequency) repetition)
						 (phone-vibrate data (jsarray->vector frequency) #unspecified)))
					    ((integer? frequency)
					     (if (and (fixnum? repetition) (>fx repetition 0))
