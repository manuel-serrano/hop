...
;*    get-androidphone ...                                             */
;*---------------------------------------------------------------------*/
(define (get-androidphone)
   (unless the-phone
      (set! the-phone (instantiate::androidphone)))
   the-phone)
...
(define (hopscript %this this scope module)
   (&with!
				   ...
				   (with-access::JsWrapper this (obj data)
					 ...
					 (else
					  (android-load-plugin obj
					     (js-tostring plugin %this)
					     data
					     (js-get this (& "pluginDirectory") %this)))))
				   (not-a-phone this)))
	 ...
	 (let ((plugdir (js-get this (& "pluginDirectory") %this)))
	    (unless (eq? plugdir (js-undefined))
	       (js-put! this (& "pluginDirectory") plugdir #f %this))
	    this))
...
(define (js-phone-contact::JsArray phone::phone vcard-cmap %this::JsGlobalObject)
   ...
   (define (vcard->jsobject vcard)
      (with-access::vcard vcard (familyname firstname emails phones addresses face notes)
