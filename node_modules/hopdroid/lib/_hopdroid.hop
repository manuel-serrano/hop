...
;*    Last change :  Mon May 18 11:32:37 2020 (serrano)                */
...
(define (hopscript %this this scope module)
   (&with!
	 ...
	 (cond-expand
      ...
      (define (js-phone-construct this)
	 (with-access::JsGlobalObject %this (js-object)
	    (cond-expand
	       ((library hopdroid)
		(let ((p (instantiate::JsWrapper
		   ...
		   (js-object-proto-set! p phone-proto)
      ...
      ;; phone
      (letrec ((js-phone (js-make-function %this
			    (lambda (this)
			       (unless (isa? this JsWrapper)
				  (js-phone-construct js-phone)))
			    0 (& "phone")
