	 ...
	 (with-access::JsGlobalObject %this (js-object)
	    (let ((obj (js-new0 %this js-object)))
		  ...
		  :enumerable #t)
	       (cond-expand
		  ((library hopdroid)
		   (js-bind! %this obj (& "statusBarColor")
		      :get (js-make-function %this
			      (lambda (this)
				 (if (phone? this)
				     (with-access::JsWrapper this (data)
					(js-string->jsstring (phone-status-bar data)))
				     (not-a-phone this)))
			      (js-function-arity 0 0)
			      (js-function-info :name "statusBarColor" :len 0))
		      :set (js-make-function %this
			      (lambda (this col)
				 (if (phone? this)
				     (with-access::JsWrapper this (data)
					(phone-status-bar-set! data (js-tostring color %this)))
				     (not-a-phone this)))
			      (js-function-arity 1 0)
			      (js-function-info :name "statusBarColor" :len 1))
		      :writable #t
		      :configurable #f
		      :enumerable #t)))
	       ;; the prototype
