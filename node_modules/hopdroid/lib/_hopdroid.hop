...
;*    Last change :  Thu May 21 07:46:40 2020 (serrano)                */
		      ...
		      :value (js-make-function %this
				(lambda (this frequency repetition)
				   (when (phone? this)
					 ...
					 (cond
					    ((js-array? frequency)
					     (if (and (fixnum? repetition) (>fx repetition 0))
						 (phone-vibrate data (jsarray->vector frequency %this) repetition)
						 (phone-vibrate data (jsarray->vector frequency %this) #unspecified)))
					    ((integer? frequency)
					     (if (and (fixnum? repetition) (>fx repetition 0))
						 (phone-vibrate data frequency repetition)
						 (phone-vibrate data frequency #unspecified)))
					    ((eq? frequency (js-undefined))
					     (phone-vibrate data #unspecified #unspecified))))))
				2 (& "vibrate"))
		      :writable #f
		      :enumerable #t)
