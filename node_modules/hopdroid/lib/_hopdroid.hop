...
;*    Last change :  Thu May 21 07:14:10 2020 (serrano)                */
				   ...
				   (when (phone? this)
					 ...
					 (cond
					    ((js-array? frequency)
						 ...
						 (phone-vibrate data (jsarray->vector frequency) #undefined)))
					    ((integer? frequency)
					     (if (and (fixnum? repetition) (>fx repetition 0))
						 (phone-vibrate data frequency repetition)
						 (phone-vibrate data frequency #undefined)))
					    ((eq? frequency (js-undefined))
					     (phone-vibrate data #undefined #undefined))))))
				2 (& "vibrate"))
		      :writable #f
		      :enumerable #t)
