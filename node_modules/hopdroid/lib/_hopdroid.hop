...
(define (vcard->jsobject vcard cmap %this)
   ...
   (define (get-note key notes %5his)
      (if (pair? notes)
   ...
   (with-access::vcard vcard (id familyname firstname emails phones addresses photo notes x-thumbnail)
      (tprint "vcard fname=[" familyname "] first=[" firstname "] id="
	 id " " (typeof id) " x-thumb=" x-thumbnail)
