	    ...
	    (let ((obj (js-new0 %this js-object)))
		  ...
		  :value (js-make-function %this
			    (lambda (this id)
				   ...
				   (not-a-phone this)))
			    (js-function-arity 1 0)
			    (js-function-info :name "contacts" :len 1))
		  :writable #f
		  :enumerable #t)
...
;*---------------------------------------------------------------------*/
(define (js-phone-contact-list::JsArray phone::phone projection selection cmap %this::JsGlobalObject)
   (js-vector->jsarray
...
;*    js-phone-contact ...                                             */
;*---------------------------------------------------------------------*/
(define (js-phone-contact::JsArray phone::phone id cmap %this::JsGlobalObject)
   (vcard->jsobject (phone-contact phone id) cmap %this))
