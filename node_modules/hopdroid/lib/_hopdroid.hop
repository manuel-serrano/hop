...
;*    Last change :  Wed May 20 12:06:57 2020 (serrano)                */
					 ...
					 (let ((w (js-current-worker)))
					    (add-event-listener! data
						  (js-tostring event %this)
					       (lambda (e)
						  (tprint "JS listener.1 event=" event " e=" (typeof e))
						  (with-access::event e (value)
						     (tprint "JS listener.2 event=" event " value=" value)
						     (with-handler
							(lambda (exn)
							...
							(let ((o (js-alist->jsobject
								    `((target . ,this)
								      ...
								      (value . ,value))
								    %this)))
							   (tprint "JS listener.3 o=" (typeof o))
