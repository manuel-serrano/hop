...
;*    Last change :  Thu May 21 06:42:28 2020 (serrano)                */
				   ...
				   (when (phone? this)
					 ...
					 (cond
					    ((js-array? frequency)
						 ...
						 (phone-vibrate data (jsjsarray->vector frequency) repetition)
						 (phone-vibrate data (jsjsarray->vector frequency))))
					    ((integer? frequency)
					     (if (and (fixnum? repetition) (>fx repetition 0))
						 (phone-vibrate data frequency repetition)
						 (phone-vibrate data frequency)))
