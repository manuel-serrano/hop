...
;*---------------------------------------------------------------------*/
(define-method (phone-contact-list::pair-nil this::androidphone #!optional projection selection)
   (let ((lst (if (equal? selection "phone")
		  (filter (lambda (vc)
...
;*---------------------------------------------------------------------*/
(define-method (phone-contact this::androidphone id)
   (find (lambda (vc)
	    (with-access::vcard vc (uid)
	       (string=? uid id)))
      simulated-contacts))
