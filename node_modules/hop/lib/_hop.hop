...
;*    Last change :  Thu May 16 11:42:40 2024 (serrano)                */
...
;*    js-create-service ...                                            */
;*---------------------------------------------------------------------*/
(define (js-create-service %this::JsGlobalObject impl path loc register import worker::WorkerHopThread table server::JsObject)
