...
;*    Last change :  Wed Aug 28 08:45:20 2024 (serrano)                */
...
(define (hopscript %this this %scope %module)
   ...
   (js-export (createScheduler
	 ...
	 (let ((name (js-get user (& "name") %this))
      ...
      (define digestPasswordEncrypt
	 (js-function (lambda (this name pass realm)
			 (js-string->jsstring
			    (digest-password-encrypt
			       (js-tostring name %this)
			       (js-tostring pass %this)
			       (js-tostring realm %this))))
	    "digestPasswordEncrypt"))
