...
/*    Last change :  Wed Apr  3 10:43:19 2024 (serrano)                */
...
export function listen(motd?: undefined | string): void;
...
export class Resolver {
    ...
    resolve(mod: string): Promise<string>;
...
/*    resolve ...                                                      */
/*---------------------------------------------------------------------*/
export function register(path: string): string;
...
/*    broadcast                                                        */
/*---------------------------------------------------------------------*/
export function broadcast(event: string, val: any): void;
