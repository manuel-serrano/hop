/*=====================================================================*/
/*    serrano/prgm/project/hop/hop/node_modules/hop/type/hop.d.ts      */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Tue Oct 24 09:46:13 2023                          */
/*    Last change :  Thu May 16 12:03:45 2024 (serrano)                */
...
export interface Config {
   ...
   listenAddress: string | false;
   soMaxConn: number,
   maxThread: number,
   configDirectory: string;
   cacheDirectory: string;
   usersdb: string | undefined;
   verbose: number;
   debug: number;
   charset: string;
   security: {
...
export class Hop {
   ...
   Service(fun: (...args: any) => any, optOrUrl: any): (...args) => Frame;
   broadcast(evt: string, val: any): void;
...
export class Resolver {
   constructor(hop: Hop, root: string);
...
export function HTTPResponseString(str: string, opt?: HTTPResponseHeader): Response;
export function HTTPResponseAuthentication(opt?: HTTPResponseHeader): Response;
export function HTTPResponseFile(path: string, opt?: HTTPResponseHeader): Response;
export function HTTPResponseHTML(xml: HTMLElement, opt?: HTTPResponseHeader): Response;
...
export function AUDIO(attrs: XmlAttrs, ...nodes: any[]): HTMLElement;
...
export function VIDEO(attrs: XmlAttrs, ...nodes: any[]): HTMLElement;
