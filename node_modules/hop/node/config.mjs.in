...
/*    Last change :  Tue Apr  2 14:29:03 2024 (serrano)                */
...
function loadUsersDB(config, descr) {
   if (descr.match(/\.json$/)) {
      config.users = JSON.parse(readFileSync(descr, "utf8"));
...
function init(cfg) {
   ...
   config.users.forEach(u => {
      ...
      Object.freeze(u.directories.map(resolveDir))
      Object.freeze(u)
   });
