/*=====================================================================*/
/*    .../project/hop/3.7.x/node_modules/hop/node/hop-loader.mjs       */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Fri Nov 17 08:15:59 2023                          */
/*    Last change :  Tue Feb 13 09:29:36 2024 (serrano)                */
...
import { compile as hopCompile } from "./hopc-compiler.mjs";
import { compile as tsCompile } from "./ts-compiler.mjs";
...
async function compile(url) {
   ...
   const npath = await HopCompile(path);

   if (npath.match(/\.ts$/)) {
      return TsCompile(npath);
   } else {
      return npath;
   }
}
...
/*    TsCompile ...                                                    */
/*---------------------------------------------------------------------*/
async function TsCompile(path) {
   const target = path.replace(/\.ts$/, ".mjs");
