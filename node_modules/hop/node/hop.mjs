...
/*    Last change :  Thu May  2 07:31:27 2024 (serrano)                */
...
import { init as eventInit, broadcast, serverEventInit, registerWebsocket } from "./event.mjs";
...
class Hop {
   ...
   constructor(config) {
	 ...
	 default: throw new TypeError(`Illlegal engine "${this.config.engine}"`);
      ...
      this.#broadcast = eventInit(this.config, hopResponse);
