...
/*    Last change :  Sun Mar 10 10:11:55 2024 (serrano)                */
...
function Service(fun, optOrUrl) {
   ...
   return (...args) => new Frame(impl, args);
}
...
class ServiceImpl {
   ...
   constructor(fun, optOrUrl) {
	 ...
	 backend.get(this.#path, Service.getResponse.bind(this));
	 backend.post(this.#path, Service.postResponse.bind(this));
	 backend.put(this.#path, Service.putResponse.bind(this));
...
class Frame {
   ...
   toString() {
      return `http://${hopInit().ports.http}/${this.#svc.path()}`;
   }
}
