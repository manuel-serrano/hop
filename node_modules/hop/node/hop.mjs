...
/*    Last change :  Wed Feb 21 13:50:15 2024 (serrano)                */
...
/*    expressInit ...                                                  */
/*---------------------------------------------------------------------*/
function expressInit(config) {
   if (!express) {
      express = require("../../../express");
      app = express();
      if (config.ports.http >= 0) app.listen(config.ports.http);
      if (config.ports.https >= 0) app.listen(config.ports.https);
