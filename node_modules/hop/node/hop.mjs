...
/*    Last change :  Mon Feb  5 10:25:36 2024 (serrano)                */
...
import { authorizedService } from "./auth.mjs";
...
function expressInit() {
   if (!express) {
      ...
      app.use(`${hopBase}/0`, express.static(path.dirname(getRootDir(import.meta.url))));
   }
}
