...
/*    Last change :  Mon Jan 22 07:59:38 2024 (serrano)                */
...
function addHopImport(prog) {
   ...
   let prev = null;
   const imp = parseString("import { BODY, DIV, DOLLAR, HTML, HEAD, SCRIPT, SPAN, STYLE, TILDE } from \"@hop/hop\"");
