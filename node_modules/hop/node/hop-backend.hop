...
;*    Last change :  Sat Mar  2 06:47:37 2024 (serrano)                */
...
(define (hopscript %this this %scope %module)
   ...
   (define query-object
      (js-new-proxy %this '() (class-nil JsObject)))
			...
			(with-access::http-request obj (query header)
			   (tprint "R=" (typeof obj))
			   (tprint "QUERY " header
			      " " propname)
			   (js-undefined)))))
   ...
   (define request-elements
	 ...
	 (instantiate::JsWrapperDescriptor
	    ...
	    (%get (lambda (obj owner propname %this)
		     (with-access::JsWrapper obj (data)
			data)))
	    (%set list))
	 (instantiate::JsWrapperDescriptor
	    (name (& "query"))
   ...
   ;; pre-allocate these strings because we will need them in a
