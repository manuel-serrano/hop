...
;*    Last change :  Wed May  6 07:16:18 2020 (serrano)                */
...
(define (markdown-parse ip cset this scope fontifier)
	 ...
	 (let* ((lines (read/rp *quote-code-block-grammar* ip
	    ...
	    (values 'block
		  ...
		  :class (if (string? class)
			     ...
			     "fontifier-prog")
		  (apply <MARKDOWN:CODE> :%context this body))))))
   ...
   (define (pre state::MDState token indent)
	 ...
	 (values 'block (<MARKDOWN:PRE> :%context this (apply <MARKDOWN:CODE> :%context this lines)))))
