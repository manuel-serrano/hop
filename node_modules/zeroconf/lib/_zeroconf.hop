...
;*    Last change :  Fri Sep 16 08:32:24 2022 (serrano)                */
...
;*---------------------------------------------------------------------*/
(cond-expand
   ((not (and enable-avahi (library avahi)))
;;; avahi not available    
...
;*---------------------------------------------------------------------*/
;*    js-cast-object ::avahi ...                                       */
;*---------------------------------------------------------------------*/
(define-method (js-cast-object obj::avahi %this::JsGlobalObject name)
   (instantiateJsWrapper
      (__proto__ (js-null))
      (obj obj)
      (data '())
      (cmap (make-class-cmap zeroconf %this))
      (elements (make-class-elements zeroconf %this))))

;*---------------------------------------------------------------------*/
;*    js-obj->jsobject ::avahi ...                                     */
;*---------------------------------------------------------------------*/
(define-method (js-obj->jsobject obj::avahi %this::JsGlobalObject)
   (js-cast-object obj %this "js-obj->jsobject"))
...
(define (hopscript %this this %scope %module)
   ...
   (js-export (Zeroconf)
	 ...
	 (make-class-elements zeroconf-service-event %this))

      (define service-event-cmap
	 (make-class-cmap zeroconf-service-event %this))
