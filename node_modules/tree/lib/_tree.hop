;*=====================================================================*/
;*    serrano/prgm/project/hop/hop/node_modules/tree/lib/_tree.hop     */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Sun Jul  6 06:15:53 2014                          */
;*    Last change :  Mon Oct 14 08:37:37 2019 (serrano)                */
...
;*    js-tree-bind-tag! ...                                            */
;*---------------------------------------------------------------------*/
(define-macro (js-tree-bind-tag! %this obj tag)
   `(begin
       (js-bind! ,%this ,obj (& ,(symbol->string tag))
	  :value (js-make-function ,%this
		    (lambda (this attrs . nodes)
...
;*    js-tree-bind-tags! ...                                           */
;*---------------------------------------------------------------------*/
(define-macro (js-tree-bind-tags! %this obj . tags)
   `(begin
       ,@(map (lambda (tag)
		 `(js-tree-bind-tag! ,%this ,obj ,tag))
	    tags)))
...
(define (hopscript %this this scope module)
   (let ((exports (js-get module (& "exports") %this)))
      ...
      (js-tree-bind-tags! %this exports TRLEAF TRHEAD)))
