;*=====================================================================*/
;*    /tmp/HOPNEW/hop/node_modules/hss/lib/_hss.hop                    */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Fri Jun 19 13:21:01 2015                          */
;*    Last change :  Sun Feb 23 15:48:47 2020 (serrano)                */
...
(define (hopscript %this this scope module)
   ...
   (let ((exports (js-get module (& "exports") %this)))
	 ...
	 :value (js-make-function %this
		   ...
		   (js-function-info :name "parseWeColor" :len 1)))
	 ...
	 :value (js-make-function %this
		   ...
		   (js-function-info :name "makeWebColor" :len 3)))
	 ...
	 :value (js-make-function %this
		   (lambda (this obj media)
			 ...
			 (hss-read obj
			    ...
			    module %this)))
		   (js-function-arity 2 0)
		   (js-function-info :name "eval" :len 2))
	 :writable #f
	 :enumerable #f)
	 ...
	 ((getComputedStyle)
	  (js-make-function %this
		...
		(css-get-computed-style this node))
	     (js-function-arity 2 0)
	     (js-function-info :name "getComputedStyle" :len 2)))
	 (else
	  (js-undefined)))))
...
(define-method (js-get o::css-style prop %this::JsGlobalObject)
   ...
   (let loop ((pname (js-toname prop %this)))
	 ...
	 ((getPropertyValue)
	  (js-make-function %this
	     (lambda (this val)
		(let ((name (js-toname val %this)))
		   (get o name)))
	     (js-function-arity 1 0)
	     (js-function-info :name "getPropertyValue" :len 1)))
	 ((getPropertyPriority)
	  (js-make-function %this
	     (lambda (this val)
		(let ((name (js-toname val %this)))
		   (get o name)))
	     (js-function-arity 1 0)
	     (js-function-info :name "getPropertyPriority" :len 1)))
	 (else
	  (get o pname)))))
