...
export function exif(props) {
    ...
    this.software = false;
    this.comment = false;
    Object.defineProperty(this, "$commentpos", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    });
    Object.defineProperty(this, "$commentlen", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    ...
    Object.defineProperty(this, "$orientationpos", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    ...
    Object.defineProperty(this, "$thunmnailPath", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    });
    Object.defineProperty(this, "$thunmnailOffset", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    });
    Object.defineProperty(this, "$thunmnailLength", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    ...
    Object.defineProperty(this, "$gpsTag", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    });
    Object.defineProperty(this, "$gpsLatitudeRef", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    ...
    Object.defineProperty(this, "$gpsLongitudeRef", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
    ...
    Object.defineProperty(this, "$gpsAltitudeRef", {
        value: false,
        enumerable: false,
        writable: true,
        configurable: false
...
const getformatRat3 = ((en, bytes, valptr, fmt) => {
    {
        let sz = _exifFormatsSize_[fmt],
            r0 = getformat(en, bytes, valptr, fmt),
            r1 = getformat(en, bytes, (valptr + sz), fmt),
            r2 = getformat(en, bytes, (valptr + (sz + sz)), fmt);
        return ((car(r0) / cdr(r0)) + ((car(r1) / (60.0 * cdr(r1))) + (car(r2) / (3600.0 * cdr(r2)))));
    }
})
...
const processExifDir$ = ((en, bytes, start, base, exif, o0, tagBase) => {
    let strncpy = ((o, max) => {
                ...
                if ((de < dnum)) {
                    let da = (start + (2 + (12 * de))),
                        ...
                        switch ((tag + tagBase)) {
                            ...
                            case 65537: {
                                let obj1004 = exif;
                                obj1004['$gpsLatitudeRef'] = strncpy(valptr, bcount);
                            }
                            break;
                            case 65538: {
                                let obj1005 = exif;
                                obj1005.gpsLatitude = getformatRat3(en, bytes, valptr, fmt);
                            }
                            break;
                            case 65539: {
                                let obj1006 = exif;
                                obj1006['$gpsLongitudeRef'] = strncpy(valptr, bcount);
                            }
                            break;
                            case 65540: {
                                let obj1007 = exif;
                                obj1007.gpsLongitude = getformatRat3(en, bytes, valptr, fmt);
                            }
                            break;
                            case 65541: {
                                let obj1008 = exif;
                                obj1008['$gpsAltitudeRef'] = getformat_fx(en, bytes, valptr, fmt);
                            }
                            break;
                            case 65542: {
                                let obj1009 = exif;
                                obj1009.gpsAltitude = getformat(en, bytes, valptr, fmt);
                            }
                            break;
                            case 65543: {
                                let obj1010 = exif;
                                obj1010.gpsTimeStamp = getformatRat3(en, bytes, valptr, fmt);
                            }
                            break;
                            case 65544: {
                                let obj1011 = exif;
                                obj1011.gpsSatelites = strncpy(valptr, bcount);
                            }
                            break;
                            case 65545: {
                                let obj1012 = exif;
                                obj1012.gpsStatus = strncpy(valptr, bcount);
                            }
                            break;
                            case 65546: {
                                let obj1013 = exif;
                                obj1013.gpsMeasureMode = strncpy(valptr, bcount);
                            }
                            break;
                            case 65563:
                            case 65564:
                            ...
                            case 65565: {
                                let obj1014 = exif;
                                obj1014.gpsDateStamp = strncpy(valptr, bcount);
                            }
                            break;
                            case 65547:
                                undefined;
                            ...
                            case 262: {
                                let c = getformat(en, bytes, valptr, fmt); {
                                    let obj1019 = exif;
                                    obj1019.jpegCompress = c;
                                }
                            }
                            break;
                            case 270: {
                                let obj1020 = exif;
                                obj1020.description = strncpy(valptr, bcount);
                            }
                            break;
                            case 271: {
                                let obj1021 = exif;
                                obj1021.make = strncpy(valptr, 31);
                            }
                            break;
                            case 272: {
                                let obj1022 = exif;
                                obj1022.model = strncpy(valptr, 39);
                            }
                            break;
                            case 273:
                                'todo';
                            ...
                            case 296: {
                                let ru = getformat(en, bytes, valptr, fmt); {
                                    let obj1026 = exif;
                                    obj1026.resolutionUnit = ru;
                                }
                            }
                            break;
                            case 305: {
                                let obj1027 = exif;
                                obj1027.software = strncpy(valptr, bcount);
                            }
                            break;
                            case 306: {
                                let dt = strncpy(valptr, 31); {
                                    let obj1028 = exif;
                                    obj1028.date = parseExifDate(dt);
                                }
                            }
                            break;
                            case 315: {
                                let obj1029 = exif;
                                obj1029.artist = strncpy(valptr, bcount);
                            }
                            break;
                            case 330:
                                'ignored';
                            ...
                            case 18249: {
                                let ra = getformat(en, bytes, valptr, fmt); {
                                    let obj1037 = exif;
                                    obj1037.ratingPercentage = ra;
                                }
                            }
                            break;
                            case 33432: {
                                let obj1038 = exif;
                                obj1038.copyright = strncpy(valptr, bcount);
                            }
                            break;
                            case 33434: {
                                let et = getformat(en, bytes, valptr, fmt); {
                                    let obj1039 = exif;
                                    obj1039.exposureTime = et;
                                }
                            }
                            break;
                            case 33437: {
                            ...
                            case 34665: {
                                ...
                                processExifDir$(en, bytes, ss, base, exif, o0, 0);
                            }
                            break;
                            case 34850: {
                                let e = getformat(en, bytes, valptr, fmt); {
                                    let obj1041 = exif;
                                    obj1041.exposureProgram = e;
                                }
                            }
                            break;
                            case 34853: {
                            ...
                            case 36868: {
                                let obj1044 = exif;
                                obj1044.date = parseExifDate(strncpy(valptr, 19));
                            }
                            break;
                            case 36880: {
                                let obj1045 = exif;
                                obj1045.offsetTime = strncpy(valptr, bcount);
                            }
                            break;
                            case 36881: {
                                let obj1046 = exif;
                                obj1046.offsetTimeOriginal = strncpy(valptr, bcount);
                            }
                            break;
                            case 36882: {
                                let obj1047 = exif;
                                obj1047.offsetTimeDigitized = strncpy(valptr, bcount);
                            }
                            break;
                            case 37121:
                                undefined;
                            ...
                            case 37386: {
                                let fl = getformat(en, bytes, valptr, fmt); {
                                    let obj1057 = exif;
                                    obj1057.focalLength = fl;
                                }
                            }
                            break;
                            case 37510: {
                                let obj1058 = exif;
                                obj1058['$commentpos'] = (valptr + o0);
                                obj1058['$commentlen'] = 199;
                                if (bytes.substring(valptr, valptr + 8) === "ASCII\u0000\u0000\u0000") obj1058.comment = removeTrailingSpaces$(strncpy((8 + valptr), 191));
                            }
                            break;
                            case 37500: {
                                let obj1059 = exif;
                            ...
                            case 41486: {
                                let r = getformat(en, bytes, valptr, fmt); {
                                    let obj1063 = exif;
                                    obj1063.focalPlaneXres = (pairp(r)) ? ((car(r) / cdr(r))) : (r);
                                }
                            }
                            break;
                            case 41487: {
                                let r = getformat(en, bytes, valptr, fmt); {
                                    let obj1064 = exif;
                                    obj1064.focalPlaneYres = (pairp(r)) ? ((car(r) / cdr(r))) : (r);
                                }
                            }
                            break;
                            case 41488: {
                            ...
                            case 41996: {
                                let d = (() => {
                                    ...
                                    let obj1077 = exif;
                                    obj1077.distanceSubjectRange = d;
                                }
                            }
                            break;
                            case 42035: {
                                let obj1078 = exif;
                                obj1078.lensMake = strncpy(valptr, bcount);
                            }
                            break;
                            case 42036: {
                                let obj1079 = exif;
                                obj1079.lensModel = strncpy(valptr, bcount);
                            }
                            break;
                            case 42080: {
                                let obj1080 = exif;
                                obj1080.compositeImage = strncpy(valptr, bcount);
                            }
                            break;
                            case 50706:
                            case 50707:
                            ...
                            case 50708: {
                                let obj1081 = exif;
                                obj1081.uniqueCameraModel = strncpy(valptr, bcount);
                            }
                            break;
                            case 50709:
                                'ignored';
                            ...
                            case 50735: {
                                let obj1082 = exif;
                                obj1082.cameraSerialNumber = strncpy(valptr, bcount);
                            }
                            break;
                            case 50739:
                                'ignored';
        ...
        if (((start + (2 + (4 + (12 * dnum)))) < bytes.length)) {
            ...
            if ((of > 0)) return processExifDir$(en, bytes, (of + base), base, exif, o0, 0);
        }
    }
})
    ...
    if ((bytes[4] === '\u0000') && (bytes[5] === '\u0000')) {
        ...
        if (!(hd === 42)) return exifError("read-jpeg-exif", "Illegal exif header", hd);
            ...
            if (((fo < 8)) || ((fo > 16))) return exifError("read-jpeg-exit", "Suspicious offset of first IFD value", fo);
                ...
                let obj1083 = exif;
                obj1083.endianess = en;
                processExifDir$(en, bytes, (6 + fo), 6, exif, pos, 0);
                if ((typeof(obj1083.ewidth) === 'number') && (typeof(obj1083.focalPlaneXres) === 'number') && (typeof(obj1083.focalPlaneUnits) === 'number')) {
                    let w = ((obj1083.ewidth * obj1083.focalPlaneUnits) / obj1083.focalPlaneXres);
                    obj1083.cddWidth = w;
                }
                if ((Number.isInteger(obj1083['$thunmnailOffset'])) && (Number.isInteger(obj1083['$thunmnailLength']))) {
                    let th = Buffer.from(bytes.substring(obj1083['$thunmnailOffset'], (obj1083['$thunmnailOffset'] + obj1083['$thunmnailLength'])), "binary");
                    obj1083.thumbnail = th;
                    return exif;
                } else return obj1083.thumbnail = false;
            }
        }
    }
})
const readCom$ = ((exif, bytes, pos) => {
    {
        let obj1084 = exif; {
            let len = bytes.length; {
                const loop$ = ((function loop(i) {
                    if (i === len) return obj1084.comment = bytes;
                    else if (bytes[i] === '\u0000') {
                        let s = bytes.substring(0, i);
                        obj1084.comment = s;
                        obj1084['$commentpos'] = pos;
                        return obj1084['$commentlen'] = i;
                    } else return loop((i + 1));
                })(0));
                return loop$;
            }
...
const readSofn$ = ((exif, bytes, encoding) => {
    {
        let obj1085 = exif;
        obj1085.width = get16u(true, bytes, 3);
        obj1085.height = get16u(true, bytes, 1);
        obj1085.jpegEncoding = encoding;
    }
    return exif;
})
const readJpegSection = ((mm, path) => {
    const loop$ = ((function loop(a, m) {
        if (m === '\u00ff')
            ...
            else if (((l + mm.rindex) > mm.length)) return exifError("read-jpeg-section", "Premature end of section read: " + (mm.length - mm.rindex), ", expected: " + l - 2);
            else {
                let offset = mm.rindex;
                return [m.charCodeAt(0), mm.toString((l - 2)), offset];
            }
        }
    })(0, mm.get()));
    return loop$;
    ...
    mm.rindex = 0; {
        ...
        if (m !== 216) exifError("read-jpeg-sections", "Illegal section marker", (mm.rindex - 1));
            ...
            const loop$ = ((function loop() {
                {
                    let [m, bytes, offset] = readJpegSection(mm, path);
                    switch (m) {
                        case 218:
                            return 'sos';
                            break;
                        ...
                        case 224:
                            ...
                            break;
                        case 225:
                            if (bytes.substring(0, 6) === "Exif\u0000\u0000") {
                                let obj1086 = exif;
                                readJpegExif$(exif, bytes, mm.rindex - bytes.length);
                                if (obj1086['$gpsTag']) {
                                    processExifDir$(obj1086.endianess, bytes, (obj1086['$gpsTag'] + 6), 6, exif, 0, 65536); {
                                        let obj1087 = exif;
                                        if (obj1087['$gpsAltitudeRef'] === 1) setCar$(obj1087.gpsAltitude, -car(obj1087.gpsAltitude));
                                        if (obj1087['$gpsLatitudeRef'] == "S") obj1087.gpsLatitude = -obj1087.gpsLatitude;
                                        if (obj1087['$gpsLongitudeRef'] == "W") obj1087.gpsLongitude = -obj1087.gpsLongitude;
                                    }
                                }
                            }
                            return loop();
...
const readTiffSections = ((exif, mm, path) => {
    ...
    let readIfd = ((en, offset) => {
        return processExifDir$(en, mm, offset, 0, exif, 0, 0);
    }); {
...
const tiffp = ((mm) => {
    let res = (() => {
        switch (mm.ref(0)) {
            case "I":
                console.error("tiff 73");
                return (mm.get() === 'I') && (mm.get() === '*') && (mm.get() === '\u0000');
                break;
            case "M":
                console.error("tiff 77");
...
const rw2p = ((mm) => {
    let res = (mm.ref(0) === 'I') && (mm.get() === 'I') && (mm.get() === 'U') && (mm.get() === '\u0000') && (memqArray(mm.get(), ['', ''])) && (mm.get() === '\u0000') && (mm.get() === '\u0000') && (mm.get() === '\u0000');
    if (!res) mm.rindex = 0;
    return res;
})
const jpegExif = ((path) => {
        ...
        try {
            if ((mm.length > 0)) {
                readJpegSections(exf, mm, path); {
                    let obj1088 = exf;
                    return (obj1088['$commentpos']) && ((((len, s) => {
                        mm.windex = obj1088['$commentpos'];
                        mmapPutString$(mm, "ASCII\u0000\u0000\u0000");
                        mmapPutString$(mm, s);
                        mmapPutString$(mm, "\u0000");
                        mtime = true;
                        return s;
                    })(comment.length, ((len < obj1088['$commentlen'])) ? (comment) : (comment.substring(0, obj1088['$commentlen'])))));
                }
            }
        } finally {
            mm.close();
    ...
    if (!(fs.existsSync(path))) return error_errno($errnoIoFileNotFoundError, "jpeg-exif-comment-set!", "Can't find file", path);
        ...
        try {
            if ((mm.length > 0)) {
                readJpegSections(exf, mm, path); {
                    let obj1089 = exf;
                    if (obj1089['$orientationpos']) {
                        mm.windex = obj1089['$orientationpos'];
                        switch (orientation) {
                            case 'landscape':
                                mmapPutString$(mm, "");
                                break;
