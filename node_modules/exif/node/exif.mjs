                ...
                if ((de < dnum)) {
                    let da = (start + (2 + (12 * de))),
                        ...
                        switch (tag) {
                            ...
                            break;
                            case 270:
                                exif.description = strncpy(valptr, bcount);
                                break;
                            case 271:
                                exif.make = strncpy(valptr, 31);
                                break;
                            case 272:
                                exif.model = strncpy(valptr, 39);
                                break;
                            case 273:
                                'todo';
                                break;
                            ...
                            case 296: {
                                ...
                                exif.resolutionUnit = ru;
                            }
                            break;
                            case 305:
                                exif.software = strncpy(valptr, bcount);
                                break;
                            case 306: {
                                let dt = strncpy(valptr, 31);
                                exif.date = parseExifDate(dt);
                            }
                            break;
                            case 315:
                                exif.artist = strncpy(valptr, bcount);
                                break;
                            case 330:
                                'ignored';
                                break;
                            case 513: {
                                let ol = getformat_fx(en, bytes, valptr, fmt),
                                    of = (ol + base);
                                exif.thumbnailOffset = of;
                            }
                            break;
                            case 514: {
                                let le = getformat_fx(en, bytes, valptr, fmt);
                                exif.thumbnailLength = le;
                            }
                            break;
                            case 515:
                                'todo';
                            ...
                            case 530: {
                                ...
                                exif.YCbCrSubsampling = ss;
                            }
                            break;
                            case 531: {
                                let pos = getformat_fx(en, bytes, valptr, fmt);
                                exif.YCbCrPositioning = pos;
                            }
                            break;
                            case 532: {
                            ...
                            case 18249: {
                                let ra = getformat(en, bytes, valptr, fmt);
                                exif.ratingPercentage = ra;
                            }
                            break;
                            case 33432:
                                exif.copyright = strncpy(valptr, bcount);
                                break;
                            case 33434: {
                                let et = getformat(en, bytes, valptr, fmt);
                                exif.exposureTime = et;
                            }
                            break;
                            case 33437: {
                            ...
                            case 36867:
                            case 36868:
                                exif.date = parseExifDate(strncpy(valptr, 19));
                                break;
                            case 36880:
                                exif.offsetTime = strncpy(valptr, bcount);
                                break;
                            case 36881:
                                exif.offsetTimeOriginal = strncpy(valptr, bcount);
                                break;
                            case 36882:
                                exif.offsetTimeDigitized = strncpy(valptr, bcount);
                                break;
                            case 37121:
                                undefined;
                                break;
                            ...
                            case 37377: {
                                ...
                                exif.shutterSpeedValue = sv;
                            }
                            break;
                            case 37379: {
                                let bv = getformat(en, bytes, valptr, fmt);
                                exif.brightnessValue = bv;
                            }
                            break;
                            case 37378: {
                            ...
                            break;
                            case 37510:
                                exif['$commentpos'] = (valptr + o0);
                                exif['$commentlen'] = 199;
                                if (bytes.substring(valptr, valptr + 8) === "ASCII\u0000\u0000\u0000") exif.comment = removeTrailingSpaces$(strncpy((8 + valptr), 191));
                                break;
                            case 37500:
                            ...
                            case 41486: {
                                ...
                                exif.focalPlaneXres = (pairp(r)) ? ((car(r) / cdr(r))) : (r);
                            }
                            break;
                            case 41487: {
                                let r = getformat(en, bytes, valptr, fmt);
                                exif.focalPlaneYres = (pairp(r)) ? ((car(r) / cdr(r))) : (r);
                            }
                            break;
                            case 41488: {
                                let fpu = (() => {
                                ...
                                exif.focalPlaneUnits = fpu;
                            }
                            break;
                            case 41495: {
                                let sm = getformat(en, bytes, valptr, fmt);
                                exif.sensingMethod = sm;
                            }
                            break;
                            case 41728:
                                undefined;
                            ...
                            case 41988: {
                                ...
                                exif.digitalZoomRatio = dz;
                            }
                            break;
                            case 41989: {
                                let fl = getformat(en, bytes, valptr, fmt);
                                exif.focalLength35 = fl;
                            }
                            break;
                            case 41990: {
                                let mm = (() => {
                            ...
                            case 41996: {
                                ...
                                exif.distanceSubjectRange = d;
                            }
                            break;
                            case 42035:
                                exif.lensMake = strncpy(valptr, bcount);
                                break;
                            case 42036:
                                exif.lensModel = strncpy(valptr, bcount);
                                break;
                            case 42080:
                                exif.compositeImage = strncpy(valptr, bcount);
                                break;
                            case 50706:
                            case 50707:
                                'ignored';
                                break;
                            case 50708:
                                exif.uniqueCameraModel = strncpy(valptr, bcount);
                                break;
                            case 50709:
                                'ignored';
                                break;
                            ...
                            case 50734:
                                ...
                                break;
                            case 50735:
                                exif.cameraSerialNumber = strncpy(valptr, bcount);
                                break;
                            case 50739:
                                'ignored';
                                break;
...
const readJpegExif$ = ((exif, bytes, pos) => {
    ...
    if ((bytes[4] === '\u0000') && (bytes[5] === '\u0000')) {
        ...
        if (!(hd === 42)) return exifError("read-jpeg-exif", "Illegal exif header", hd);
            ...
            else processExifDir$(en, bytes, (6 + fo), 6, exif, pos);
            if ((typeof(exif.ewidth) === 'number') && (typeof(exif.focalPlaneXres) === 'number') && (typeof(exif.focalPlaneUnits) === 'number')) {
                let w = ((exif.ewidth * exif.focalPlaneUnits) / exif.focalPlaneXres);
                exif.cddWidth = w;
            }
            if ((Number.isInteger(exif.thumbnailOffset)) && (Number.isInteger(exif.thumbnailLength))) {
                let th = bytes.substring(exif.thumbnailOffset, (exif.thumbnailOffset + exif.thumbnailLength));
                exif.thumbnail = th;
                return exif;
            } else return exif.thumbnail = false;
        }
    }
})
const readCom$ = ((exif, bytes, pos) => {
    {
        let len = bytes.length; {
            const loop$ = ((function loop(i) {
                if (i === len) return exif.comment = bytes;
                else if (bytes[i] === '\u0000') {
                    let s = bytes.substring(0, i);
                    exif.comment = s;
                    exif['$commentpos'] = pos;
                    return exif['$commentlen'] = i;
                } else return loop((i + 1));
            })(0));
            return loop$;
        }
...
const readSofn$ = ((exif, bytes, encoding) => {
    exif.width = get16u(true, bytes, 3);
    exif.height = get16u(true, bytes, 1);
    exif.jpegEncoding = encoding;
    return exif;
})
const readJpegSection = ((mm, path) => {
    const loop$ = ((function loop(a, m) {
        if (m === '\u00ff')
            ...
            else if (((l + mm.rindex) > mm.length)) return exifError("read-jpeg-section", "Premature end of section read: ~s", ", expected: ~s");
    ...
    if (!(fs.existsSync(path))) return error_errno($errnoIoFileNotFoundError, "jpeg-exif-comment-set!", "Can't find file", path);
        ...
        try {
            if ((mm.length > 0)) {
                ...
                return (exf['$commentpos']) && ((((len, s) => {
                    mm.windex = exf['$commentpos'];
                    mmapPutString$(mm, "ASCII\u0000\u0000\u0000");
                    mmapPutString$(mm, s);
                    mmapPutString$(mm, "\u0000");
                    mtime = true;
                    return s;
                })(comment.length, ((len < exf['$commentlen'])) ? (comment) : (comment.substring(0, exf['$commentlen'])))));
            }
        } finally {
            mm.close();
            if (mtime) {
...
const jpegExifOrientationSet$ = ((path, orientation) => {
    if (!(fs.existsSync(path))) return error_errno($errnoIoFileNotFoundError, "jpeg-exif-comment-set!", "Can't find file", path);
        ...
        try {
            if ((mm.length > 0)) {
                readJpegSections(exf, mm, path);
                if (exf['$orientationpos']) {
                    mm.windex = exf['$orientationpos'];
                    switch (orientation) {
                        case 'landscape':
                            mmapPutString$(mm, "");
                            break;
