...
${ <span class="label label-warning">Note:</span> } Some `Hop.js`
implementations do not use server properties specified in the
`hoprc.js`configuration file. You may still set the properties in the
