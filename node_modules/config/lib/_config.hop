;*=====================================================================*/
;*    .../project/hop/3.2.x/node_modules/config/lib/_config.hop        */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Fri Jun 19 13:21:01 2015                          */
;*    Last change :  Mon Nov 12 10:44:15 2018 (serrano)                */
...
(module _config
   ...
   (eval (import hop-autoload-directory-add!)
      (import hop-max-threads)
      (import hop-max-threads-set!)
      (import hop-srfis)
      (import hop-enable-webdav)
      (import hop-enable-webdav-set!)
      (import hop-proxy-ip-mask)
      (import hop-proxy-ip-mask-set!)
      (import hop-use-proxy)
      (import hop-use-proxy-set!)
      (import hop-proxy-authentication)
      (import hop-proxy-authentication-set!)
      (import hop-proxy-allow-remote-client)
      (import hop-proxy-allow-remote-client-set!)
      (import hop-proxy-remote-authentication)
      (import hop-proxy-remote-authentication-set!)
      (import hop-enable-https)
      (import hop-enable-https-set!)
      (import hop-https-pkey)
      (import hop-https-pkey-set!)
      (import hop-https-cert)
      (import hop-https-cert-set!))
...
(define (hopscript %this this scope module)
   (let ((exports (js-get module 'exports %this)))
	 ...
	 :value (js-make-function %this
		   (lambda (this path)
		      (hop-autoload-directory-add! (js-tostring path %this)))
	 ...
	 current-thread)
      ...
      (if (memq 'enable-threads (hop-srfis))
	 ...
	 hop-http-authentication hop-http-authentication-set!)
      ...
      ;; proxy
      (bind-param! %this exports string proxyIpMask
	 ...
	 hop-enable-proxying hop-enable-proxying-set!)
      (bind-param! %this exports string proxy
	 hop-use-proxy hop-use-proxy-set!)
      (bind-param! %this exports bool proxyAuthentication
	 hop-proxy-authentication hop-proxy-authentication-set!)
      (bind-param! %this exports bool proxyAllowRemoteClient
	 hop-proxy-allow-remote-client hop-proxy-allow-remote-client-set!)
      (bind-param! %this exports bool proxyRemoteAuthentication
