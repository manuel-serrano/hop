...
;*    Last change :  Thu May 26 15:28:51 2022 (serrano)                */
...
(define-tag <FTSPAN> ((data-charpos #f)
   ...
   (multiple-value-bind (id class prop)
      ...
      (cond
	 ((and prop class id)
	  (<SPAN> :id id :class class (car prop) (cdr prop) body))
	 ((and prop class)
	  (<SPAN> :class class (car prop) (cdr prop) body))
	 ((and prop id)
	  (<SPAN> :id id (car prop) (cdr prop) body))
	 (else
	  (<SPAN> :id id :class class body)))))
