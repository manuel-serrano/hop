;*=====================================================================*/
;*    .../project/hop/3.0.x/node_modules/hopdoc/lib/_hopdoc.hop        */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Thu Jul 30 08:19:26 2015                          */
;*    Last change :  Thu Jul 30 10:14:53 2015 (serrano)                */
   ...
   (with-access::JsGlobalObject %this (__proto__)
	 ...
	 (let ((file (js-jsstring->string path)))
		...
		(call-with-input-file file
		   (lambda (ip)
		      (let ((beg (if (number? beg) (js-tointeger beg %this) 0))
			 ...
			 (let loop ((i 0)
			    ...
			    (let ((line (read-line-newline ip)))
			       (cond
				  ((eof-object? line)
				   (js-stringlist->jsstring (reverse! acc)))
				  ((=fx i end)
