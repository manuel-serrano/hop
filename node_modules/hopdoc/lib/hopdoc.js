...
/*    index ...                                                        */
/*---------------------------------------------------------------------*/
function index( doc, tags=["h1", "h3"], classes=["module", "parameter", "function", "tag", "constructor", "scheme", "syntax", "ext-function", "ext-variable"] ) {
   var res = [];
   ...
   return res
	 ...
	 let proto = el.innerHTML.trim();
	 let key;
	 
	 if( el.class.indexOf( "syntax" ) >= 0 ) {
	    let i = proto.indexOf( " " );
