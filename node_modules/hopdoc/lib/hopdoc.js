...
/*    index ...                                                        */
/*---------------------------------------------------------------------*/
function index( doc, tags, classes=["module", "parameter", "function", "tag", "constructor", "scheme", "syntax", "ext-function", "ext-variable", "procedure", "class"] ) {
   var res = [];
   ...
   return res
	 ...
	 if( el.className.indexOf( "syntax" ) >= 0 ) {
	    let i = proto.indexOf( " " );
...
/*---------------------------------------------------------------------*/
function htmlToIdx( base, files, tags=["h1", "h3"] ) {
   var table = [];
