;*=====================================================================*/
;*    serrano/prgm/project/hop/3.0.x/node_modules/mkjsast.scm          */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Tue Jul  1 16:05:56 2014                          */
;*    Last change :  Tue Jul  8 08:41:47 2014 (serrano)                */
;*    Copyright   :  2014 Manuel Serrano                               */
;*    -------------------------------------------------------------    */
;*    Make the JS Ast from the Bigloo type class hierarchy             */
;*=====================================================================*/
...
(define (arg-name id)
   (case id
      ...
      ((|catch|) '_catch)
      ((|finally|) '_finally)
      (else (string->symbol (string-replace (symbol->string id) #\- #\_)))))
...
(define (parse-class clause)
   (match-case clause
      (((or class abstract-class final-class) ?name . ?fields)
