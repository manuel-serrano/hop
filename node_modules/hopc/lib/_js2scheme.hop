...
;*    Last change :  Thu Jul 18 11:14:15 2019 (serrano)                */
	 ...
	 (let loop ((i (-fx (vector-length fields) 1)))
	    (when (>=fx i 0)
		  ...
		  (cond
			 ...
			 (tprint cname " n=" n " " (class-field-type f)
			    " v="
			    (if (eq? n 'loc) v (typeof v)))
