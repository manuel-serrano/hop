;*=====================================================================*/
;*    .../hop/3.2.x-new-types/node_modules/hopc/lib/_js2scheme.hop     */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Tue Jul 17 09:48:30 2018                          */
;*    Last change :  Tue Jul 31 15:29:28 2018 (serrano)                */
...
;* 			 1 'jsToAst))                                  */
	    ...
	    (for-each (lambda (s)
	       ...
	       '(DOTS SEMICOLON COMMA LBRACE RBRACE LPAREN RPAREN ID DOLLAR
		 STRING await break case catch const continue debugger default
