...
;*    Last change :  Tue Oct 16 15:29:21 2018 (serrano)                */
   ...
   (define parser-prototype
	 ...
	 (let ((obj (js-new0 %this js-object)))
	    ...
	    (js-bind! %this obj 'parseExpression
	       ...
	       :writable #f
	       :enumerable #t)
	    (js-bind! %this obj 'parseThisExpression
	       :value (js-make-function %this
			 (lambda (this)
			    (if (vector? controller)
				(let ((self (instantiate::J2SDecl
					       ...
					       (_scmid 'this)
					       (id 'this))))
				   (let ((expr ((vector-ref controller 12) self #f #f)))
				      (js-alist->jsobject
	    ...
	    (js-bind! %this obj 'parseStatement
	       ...
	       :writable #f
	       :enumerable #t)
	    (js-bind! %this obj 'parseThisStatement
	       :value (js-make-function %this
			 (lambda (this token)
			    (let ((self (instantiate::J2SDecl
					   (loc `(at "_js2scheme" 0))
					   ...
					   (id 'this))))
			       (if (vector? controller)
				   (let ((stmt ((vector-ref controller 11) self)))
				      (js-alist->jsobject
					 `((:self . ,self) (:stmt . ,stmt))
					 %this))
				   (js-raise-type-error %this
