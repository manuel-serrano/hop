/*=====================================================================*/
/*    serrano/prgm/project/hop/3.0.x/node_modules/hopc/lib/hopc.js     */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Thu Jun 26 08:21:30 2014                          */
/*    Last change :  Thu Jul 10 12:43:57 2014 (serrano)                */
...
function linkNode( node, env ) {
   if( !(node instanceof Object) || (node instanceof Function) ) {
	 ...
	 throw "hopc, wrong ast, dangling reference: %s" + node.toString();
      }
...
function intern( ast ) {
   if( "__ast__" in ast ) {
      var env = {};
      var o = { __walk_initialized__: true };
   ...
   return {
	 ...
	 if( node instanceof Array ) {
	    node.forEach( function( v, i, a ) {
	       ...
	       a[ i ] = walkNode.apply( this, arguments );
	    } );
