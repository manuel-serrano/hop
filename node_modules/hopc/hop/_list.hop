...
;*    Last change :  Sat Jun 15 19:37:35 2024 (serrano)                */
...
(define (hopscript %this this %scope %module)
   ...
   (js-export (list list2array array2list cons pairp car cdr setCar setCdr lastPair map)
