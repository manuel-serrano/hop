/*=====================================================================*/
/*    .../project/hop/hop/node_modules/hopc/node/ts-loader.mjs         */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Fri Nov 17 08:15:59 2023                          */
/*    Last change :  Wed Mar  6 08:32:13 2024 (serrano)                */
...
const tsCompiler =
   (features.hop ? "./ts-native-compiler.mjs" : "./ts-js-compiler.mjs");
let tsCompile = false;
...
export async function load(url, context, nextLoad) {
   console.error("tsloader url=", url);
   if (extensionsRegex.test(url)) {
      return nextLoad(await compile(url));
   } else {
      return nextLoad(url);
   }
}
