...
/*    Last change :  Sun Mar 24 09:17:17 2024 (serrano)                */
...
async function compile(source, target, conf = {}) {
   try {
      ...
      const prog = new HopProgram(source, generate(addHopImport(ast), conf));
