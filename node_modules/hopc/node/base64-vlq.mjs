/*=====================================================================*/
/*    .../project/hop/3.7.x/node_modules/hopc/node/base64-vlq.mjs      */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Fri Nov 24 14:26:05 2023                          */
/*    Last change :  Fri Nov 24 16:05:29 2023 (serrano)                */
...
/*    base64VlqDecode ...                                              */
/*---------------------------------------------------------------------*/
export function base64VlqDecode(str, index) {
   ...
   for (let i = index; i < len; i++) {
	 ...
	 return {values: fromVlqSigned(result), index: i + 1};
      }
   }

   throw "Base64VlqDecode: Expected more digits in base 64 VLQ value " + i;
}

/*---------------------------------------------------------------------*/
/*    base64VlqEncode ...                                              */
/*---------------------------------------------------------------------*/
export function base64VlqEncode(val) {
