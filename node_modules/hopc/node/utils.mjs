...
/*    Last change :  Mon Jan 22 08:04:41 2024 (serrano)                */
...
export function openInputFile(path) {
   return { filename: path, buffer: readFileSync(path).toString(), offset: 0, shiftOffset: 0 };
}

export function openInputString(val) {
   return { filename: false, buffer: val.toString(), offset: 0, shiftOffset: 0 };
}
