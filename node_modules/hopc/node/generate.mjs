...
/*    Last change :  Mon Dec  4 13:46:53 2023 (serrano)                */
...
J2SIf.prototype.generate = function() {
   if (this.else.clazz === "J2SNop") {
      return new Fragment(this, "if (", this.test.generate(), ") ", this.then.clazz === "J2SNop" ? ";" : this.then.generate(), "\n");
   } else {
      return new Fragment(this, "if (", this.test.generate(), ") ", this.then.clazz === "J2SNop" ? ";" : this.then.generate(), " else ", this.else.generate(), "\n");
   }
}
