...
/*    Last change :  Thu Feb  1 13:11:41 2024 (serrano)                */
...
J2SImport.prototype.generate = function() {
   ...
   function importPath(self) {
	 ...
	 return new Fragment(self, self.dollarpath.generate());
   ...
   function importModule(self, path) {
	 ...
	 return new Fragment(self, "import ", car(self.names).generate(), ` from ${path};`);
      } else {
	 return new Fragment(self, "import { ", new FragmentList(self, list2array(self.names).map(n => n.generate()), ","), ` } from ${path};`);
      }
   }
...
J2SFun.prototype.generate = function() {
   ...
   if (asy) {
      ...
      return new Fragment(this, "async ", generateFun.call(asy, this.decl instanceof J2SDecl ? this.decl.id : "", "function"));
   } else {
...
/*    generate ::J2SYield ...                                          */
/*---------------------------------------------------------------------*/
J2SYield.prototype.generate = function() {
   return new Fragment(this, this.await ? "await " : "yield ", this.expr.generate());
}
...
/*    generate ::J2SSwitch ...                                         */
/*---------------------------------------------------------------------*/
J2SSwitch.prototype.generate = function() {
   return new Fragment(
      this, "switch (", this.key.generate(), ") {",
      new FragmentList(this, list2array(this.cases).map(n => n.generate()), "\n"),
      "}");
}
...
/*    generate ::J2SCase ...                                           */
/*---------------------------------------------------------------------*/
J2SCase.prototype.generate = function() {
   return new Fragment(this, "case ", this.expr.generate(), ": ", this.body.generate());
}

/*---------------------------------------------------------------------*/
/*    generate ::J2SDefault ...                                        */
/*---------------------------------------------------------------------*/
J2SDefault.prototype.generate = function() {
   return new Fragment(this, "default: ", this.body.generate());
}
...
J2SFor.prototype.generate = function() {
   ...
   if (this.init instanceof J2SVarDecls) {
	 ...
	 new FragmentList(this.init, decls.map(d => new Fragment(d, d.id, "=", d.val.generate()))));
   }
   return new Fragment(
      this, "for (",
      init, ";",
...
/*    J2SBreak ...                                                     */
/*---------------------------------------------------------------------*/
J2SBreak.prototype.generate = function() {
   return new Fragment(
...
/*    J2SContinue ...                                                  */
/*---------------------------------------------------------------------*/
J2SContinue.prototype.generate = function() {
   return new Fragment(
...
J2SDollar.prototype.generate = function() {
   if (this.context === "tilde-expression" || this.context === "script-expression") {
      return new Fragment(this, "${DOLLAR(", this.node.generate(), ")}");
   } else {
      return new Fragment(this, this.node.generate());
   }
}
...
/*    generate ::J2STilde ...                                          */
/*---------------------------------------------------------------------*/
J2STilde.prototype.generate = function() {
   return new Fragment(this, "TILDE(undefined, `", this.stmt.generate().toString(), "`)");
}
