/*=====================================================================*/
/*    .../project/hop/3.7.x/node_modules/hopc/node/generatesm.mjs      */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Thu Nov  2 14:38:40 2023                          */
/*    Last change :  Thu Nov 23 17:56:28 2023 (serrano)                */
...
J2SIf.prototype.generate = function() {
   return new Fragment(this, "if (", this.test.generate(), ")", this.then.clazz === "J2SNop" ? "{}" : this.then.generate(), this.else.clazz === "J2SNop" ? "{}\n" : this.else.generate());
}
