...
/*    Last change :  Thu May 16 08:02:11 2024 (serrano)                */
...
J2SImport.prototype.generate = function(conf) {
   ...
   function importPath(self) {
	 ...
	 return new Fragment(self, self.dollarpath.generate(conf));
      } else if (self.ipath instanceof J2SImportPath) {
	 return new Fragment(self, "`", self.ipath.name, "`");
      } else if (typeof self.path === "string") {
	 return new Fragment(self, "'", self.path, "'");
      } else {
   ...
   function importModule(self, path) {
      if (nullp(self.names)) {
	 return new Fragment(self, `import ${path};`);
      } else if (car(self.names).id === "*") {
	 return new Fragment(self, "import ",
			     self.types ? "type " : "",
			     car(self.names).generate(conf), ` from ${path};`);
      } else {
	 return new Fragment(self, "import ",
			     self.types ? "type { " : "{ ",
			     new FragmentList(self, list2array(self.names).map(n => n.generate(conf)), ","), ` } from ${path};`);
      }
   }
...
J2SImportDynamic.prototype.generate = function(conf) {
   return new Fragment(this, "import(", this.path.generate(conf), ")");
}
...
J2SExportDefault.prototype.generate = function(conf) {
   if (this.id === this.alias) {
      return new Fragment(this, "export default ", this.expr.generate(conf), ";", "\n");
   } else {
      return new Fragment(this, `export default as ${this.alias} `, this.expr.generate(conf), ";", "\n");
   }
}
...
J2SSeq.prototype.generate = function(conf) {
   return new Fragment(this, ...list2array(this.nodes).map(d => d.generate(conf)));
}
...
J2SBlock.prototype.generate = function(conf) {
   return new Fragment(this, "{", "\n", new FragmentList(this, list2array(this.nodes).map(d => d.generate(conf)), ""), "}");
}
...
J2SVarDecls.prototype.generate = function(conf) {
   if (this.decls) {
      return new Fragment(this, new FragmentList(this, list2array(this.decls).map(d => d.generate(conf)), ""), "\n");
   } else {
      return new Fragment(this, "");
   }
}
...
J2SDecl.prototype.generate = function(conf) {
   ...
   if (conf.typescript && this.utype) {
      ...
      if (ty !== "unknown") {
	 return new Fragment(this, binder, this.id, opt, ":", ty, sep);
      }
   }
   return new Fragment(this, binder, this.id, opt, sep);
}
...
J2SDeclInit.prototype.generate = function(conf) {
   ...
   if (conf.typescript && this.utype) {
	 ...
	 return new Fragment(
	    loc, binder,
	    new Fragment(loc, this.id, opt, ":", ty,
   ...
   return new Fragment(
      this, binder,
      new Fragment(loc + binder.length, this.id, opt, "=", this.val.generate(conf), sep));
}
...
J2SDeclFun.prototype.generate = function(conf) {
   ...
   return new Fragment(this, `${binder} ${this.id} = `,
...
J2SDeclSvc.prototype.generate = function(conf) {
   return new Fragment(this, "const ", this.id, " = Service(",
...
J2SCall.prototype.generate = function(conf) {
   ...
   const args = new FragmentList(this, list2array(this.args).map(n => n.generate(conf)));
...
J2SNew.prototype.generate = function(conf) {
   const args = new FragmentList(this, list2array(this.args).map(n => n.generate(conf)));
   return new Fragment(this, "new ", this.clazz.generate(conf), "(", args, ")");
}
...
J2SSequence.prototype.generate = function(conf) {
   return new Fragment(this, "(", new FragmentList(this, list2array(this.exprs).map(d => d.generate(conf))), ")");
}
...
J2SCond.prototype.generate = function(conf) {
   return new Fragment(this, "(", this.test.generate(conf), "?", this.then.generate(conf), ":", this.else.generate(conf), ")");
}
...
J2SParen.prototype.generate = function(conf) {
   return new Fragment(this, "(", this.expr.generate(conf), ")");
}
...
J2SString.prototype.generate = function(conf) {
   return new Fragment(this, `'${this.val.replace(/'/g, "\\'")}'`);
}
...
J2SObjInit.prototype.generate = function(conf) {
   return new Fragment(this, "{", new FragmentList(this, list2array(this.inits).map(n => n.generate(conf))), "}");
}
...
J2SPropertyInit.prototype.generate = function(conf) {
   ...
   if (name instanceof J2SString || name instanceof J2SNumber) {
      return new Fragment(this, name.generate(conf), ":", val.generate(conf));
   } else if (name instanceof J2SUndefined && val instanceof J2SSpread) {
      return new Fragment(this, "...", val.expr.generate(conf));
   } else {
      return new Fragment(this, "[", name.generate(conf), "]:", val.generate(conf));
   }
}
...
J2SDataPropertyInit.prototype.generate = function(conf) {
   ...
   if (name instanceof J2SString || name instanceof J2SNumber) {
      return new Fragment(this, name.generate(conf), ":", this.val.generate(conf));
   } else {
      return new Fragment(this, "[", name.generate(conf), "]:", this.val.generate(conf));
   }
}
...
J2SArray.prototype.generate = function(conf) {
   return new Fragment(this, "[", new FragmentList(this, list2array(this.exprs).map(e => e.generate(conf))), "]");
}
...
function generateFun(conf, id, keyword) {
   return new Fragment(this, keyword, id ? id + " " : "", "(", new FragmentList(this, list2array(this.params).map(n => n.generate(conf))), ") ", this.body.generate(conf));
}
...
J2SFun.prototype.generate = function(conf) {
   ...
   if (asy) {
      ...
      return new Fragment(this, "async ", generateFun.call(asy, conf, this.decl instanceof J2SDecl ? this.decl.id : "", "function "));
   } else {
...
J2SArrow.prototype.generate = function(conf) {
   const args = new FragmentList(this, list2array(this.params).map(n => n.generate(conf)));

   if (conf.typescript && this.rutype) {
      const ty = generateType(this.rutype, conf);
      if (ty !== "unknown") {
	 return new Fragment(this, "(", args, "): ", ty, " => ", this.body.generate(conf));
      }
   }

   return new Fragment(this, "(", args, ") => ", this.body.generate(conf));
}
...
J2SReturn.prototype.generate = function(conf) {
   return new Fragment(this, "return ", this.expr.generate(conf), ";", "\n");
}
...
J2SYield.prototype.generate = function(conf) {
   return new Fragment(this, this.await ? "await " : "yield ", this.expr.generate(conf));
}
...
J2SIf.prototype.generate = function(conf) {
   if (this.else.$class === "J2SNop") {
      return new Fragment(this, "if (", this.test.generate(conf), ") ", this.then.$class === "J2SNop" ? ";" : this.then.generate(conf), "\n");
   } else {
      return new Fragment(this, "if (", this.test.generate(conf), ") ", this.then.$class === "J2SNop" ? ";" : this.then.generate(conf), " else ", this.else.generate(conf), "\n");
   }
}
...
J2SSwitch.prototype.generate = function(conf) {
   return new Fragment(
      ...
      new FragmentList(this, list2array(this.cases).map(n => n.generate(conf)), "\n"),
      "}");
}
...
J2SCase.prototype.generate = function(conf) {
   return new Fragment(this, "case ", this.expr.generate(conf), ": ", this.body.generate(conf));
}
...
J2SDefault.prototype.generate = function(conf) {
   return new Fragment(this, "default: ", this.body.generate(conf));
}
...
J2SCatch.prototype.generate = function(conf) {
   return new Fragment(this, "catch (", this.param.generate(conf), ") ", this.body.generate(conf));
}
...
J2STry.prototype.generate = function(conf) {
   return new Fragment(this, "try ", this.body.generate(conf), this.catch.$class === "J2SNop" ? "" : this.catch.generate(conf), this.finally.$class === "J2SNop" ? "" : this.finally.generate(conf), "\n");
}
...
J2SThrow.prototype.generate = function(conf) {
   return new Fragment(this, "throw ", this.expr.generate(conf));
}
...
J2SFor.prototype.generate = function(conf) {
   ...
   if (this.init instanceof J2SVarDecls) {
	 ...
	 new FragmentList(this.init, decls.map(d => new Fragment(d, d.id, "=", d.val.generate(conf)))));
   }
   return new Fragment(
      this, "for (",
      init, ";",
...
J2SAssig.prototype.generate = function(conf) {
   return new Fragment(this, this.lhs.generate(conf), "=", this.rhs.generate(conf));
}
...
J2SAssigOp.prototype.generate = function(conf) {
   return new Fragment(this, this.lhs.generate(conf), this.op, "=", this.rhs.generate(conf));
}
...
J2SPrefix.prototype.generate = function(conf) {
   return new Fragment(this, this.op, this.rhs.lhs.generate(conf));
}
...
J2SPostfix.prototype.generate = function(conf) {
   return new Fragment(this, this.rhs.lhs.generate(conf), this.op);
}
...
J2SBindExit.prototype.generate = function(conf) {
   if (this.blb) {
      ...
      return new Fragment(this, "((() => ", this.stmt.generate(conf), ")())");
   }
}
...
J2SUnary.prototype.generate = function(conf) {
   if (this.op === "?.") {
      ...
      return new Fragment(this, this.op, " ", this.expr.generate(conf));
   } else {
      return new Fragment(this, this.op, this.expr.generate(conf));
   }
}
...
J2SBinary.prototype.generate = function(conf) {
   ...
   if (this.op === "as") {
      return new Fragment(this, this.lhs.generate(conf), " ", j2sop(this.op), " ", generateType(this.type,conf));
   } else {
      return new Fragment(this, this.lhs.generate(conf), " ", j2sop(this.op), " ", this.rhs.generate(conf));
   }
}
...
J2STemplate.prototype.generate = function(conf) {
   const nodes = list2array(this.exprs).map(n => {
	 ...
	 return new Fragment(n, "${", n.generate(conf), "}");
      }
   });
...
J2SClass.prototype.generate = function(conf) {
   return new Fragment(
      this, "class ",
      this.name ? this.name : "",
      !this.super instanceof J2SUndefined ? new Fragment(this.super, " extends ", this.super.generate(conf)) : "",
      " {", "\n",
      new FragmentList(this, list2array(this.elements).map(d => d.generate(conf)), ""),
      "}");
}
...
J2SClassElement.prototype.generate = function(conf) {
   ...
   function generateProp(prop) {
	 ...
	 return new Fragment(prop, generateName(prop.name), generateFun.call(prop.val, conf, false, ""), ";");
      } else if (prop instanceof J2SDataPropertyInit) {
	 return new Fragment(prop, generateName(prop.name), "=", prop.val.generate(conf), ";");
      } else if (prop instanceof J2SAccessorPropertyInit) {
	 return newFragmentList(
	    prop,
	    [ new Fragment(prop, "get ", generateName(prop.name), prop.get.generate(conf)),
	      prop.set ? new Fragment(prop, "set ", generateName(prop.name), prop.set.generate(conf)) : "" ]);
      } else {
...
J2SDollar.prototype.generate = function(conf) {
   if (conf.context === "tilde-expression" || conf.context === "script-expression") {
      return new Fragment(this, "${DOLLAR(", this.node.generate(conf), ",", generateLoc(this.loc), ")}");
   } else {
      return new Fragment(this, this.node.generate(conf));
   }
}
...
J2STilde.prototype.generate = function(conf) {
   ...
   nconf.context = "tilde-expression";
   return new Fragment(this, "TILDE(undefined, `", this.stmt.generate(nconf), "`)");
}
...
TsInterface.prototype.generate = function(conf) {
   if (!this.decl) {
      return new Fragment(this, "{", new FragmentList(this, list2array(this.properties).map(n => n.generate(conf)), ""), "}");
   } else {
      return new Fragment(this, this.decl, " ", this.id, "{", new FragmentList(this, list2array(this.properties).map(n => n.generate(conf)), ""), "}", "\n");
   }
}
...
TsInterfaceProperty.prototype.generate = function(conf) {
   if (this.name instanceof J2SString) {
      ...
      return new Fragment(this, name, this.optional ? "?:" : ":",
      ...
      return new Fragment(this, "[", name, ":", generateType(this.name.type, conf), "]",
			  this.optional ? "?:" : ":",
			  generateType(this.type, conf), ";");
   } else {
      return new Fragment(this, "[", this.name.generate(conf), "]",
			  this.optional ? "?:" : ":",
			  generateType(this.type, conf), ";");
   }
}
...
TsTypeFunction.prototype.generate = function(conf) {
   const tdom = new FragmentList(this, list2array(this.domain).map(t => generateType(t, conf)));
   const trange = generateType(this.range, conf);
   return new Fragment(this, "(", tdom, ") => ", trange);
}
...
TsTypeBinary.prototype.generate = function(conf) {
   ...
   return new Fragment(this, generateType(this.lhs, conf),
		       op,
