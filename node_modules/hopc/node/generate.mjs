...
J2SCall.prototype.generate = function() {
   ...
   const callee = (fclazz === "J2SRef" || fclazz === "J2SAccess" || fclazz === "J2SUnresolvedRef") ? fun : "(" + fun + ")";
   return `${callee}(${list2array(this.args).map(n => n.generate()).join()})`;
}
...
J2SBinary.prototype.generate = function() {
   ...
   return `${this.lhs.generate()}${j2sop(this.op)}${this.rhs.generate()}`;
}
