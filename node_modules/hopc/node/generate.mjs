...
/*    Last change :  Sat Mar 23 06:36:23 2024 (serrano)                */
...
import { J2SNode, J2SProgram, J2SBlock, J2SLetBlock,
	 ...
	 J2SDollar, J2STilde,
	 TsType, TsTypeArray } from "./ast.mjs";
...
J2SDeclSvc.prototype.generate = function(conf) {
   return new Fragment(this, "Service(", this.val.generate(conf),
...
TsTypeArray.prototype.generate = function(conf) {
   const val = generateType(this.of, conf);
   return new Fragment(this, val, "[]");
}
