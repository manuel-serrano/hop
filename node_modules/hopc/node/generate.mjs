...
/*    Last change :  Fri Jul  5 19:05:38 2024 (serrano)                */
...
J2SDecl.prototype.generate = function(conf) {
   ...
   return new Fragment(this, binder, this.id, sep);
}
...
J2SDeclInit.prototype.generate = function(conf) {
   ...
   return new Fragment(
      this, binder,
      new Fragment(loc + binder.length, this.id, "=", this.val.generate(conf), sep));
}
