...
/*    Last change :  Sat Jan  6 08:02:21 2024 (serrano)                */
...
J2SImport.prototype.generate = function() {
   if (nullp(this.names)) {
      ...
      return new Fragment(this, "import { ", new FragmentList(this, list2array(this.names).map(n => n.generate()), ","), ` } from "${this.path}";`, "\n");
   }
}
