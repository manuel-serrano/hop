...
/*    Last change :  Fri Jan 19 21:24:32 2024 (serrano)                */
...
export class Lexer {
   ...
   reader(port, ...opts) {
	 ...
	 if (port.buffer.length <= port.offset) {
	    ...
	    if (lix === -1) {
	       console.error(`hopc:${this.constructor.name}:NO MATCH@` + port.offset, "[" +
		  port.buffer.substring(port.offset, port.offset + 20) + "]");
