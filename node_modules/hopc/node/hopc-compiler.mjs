/*=====================================================================*/
/*    .../project/hop/hop/node_modules/hopc/node/hopc-compiler.mjs     */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Wed Oct 25 08:13:33 2023                          */
/*    Last change :  Mon Feb 19 09:43:16 2024 (serrano)                */
...
function compile(source, conf = {}) {
   try {
      ...
      return new HopProgram(source, generate(addHopImport(prog), conf));
   } catch(err) {
