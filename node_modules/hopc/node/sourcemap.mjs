...
/*    Last change :  Tue Feb 20 12:58:38 2024 (serrano)                */
...
function decode(sourceMap) {
   ...
   return { version, sources, names, lines };
}
...
function encode(lineMap) {
   const { version, sources, names, lines } = lineMap;
   let mappings = "";
   return { version, sources, names, mappings };
}
