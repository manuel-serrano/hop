/* generated file (mkjsast), do not edit (01 February 2024) */

// generated by /priv/serrano2/hop/3.7.x/node_modules/hopc/node/mkjast.scm
"use strict"
...
export function J2SDollar(loc, type, hint, range, node, context) {
  if (!new.target) {
    return new J2SDollar({"loc": array2list(loc), "type": type, "hint": array2list(hint), "range": range, "node": node, "context": context});
  } else {
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.hint = null;
        this.range = undefined;
        this.base = "/priv/serrano2/hop/3.7.x/node_modules/hopc/node";
        Object.assign(this, loc);
       }
    }
  }
