/* generated file (mkjsast), do not edit (24 March 2024) */

// generated by /home2/serrano/hop/master/node_modules/hopc/node/mkjast.scm
"use strict"

import { Cons, array2list, forEach } from "./list.mjs";
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.path = path;
        this["pcache-size"] = pcache_size;
        this["rxcache-size"] = rxcache_size;
        this["call-size"] = call_size;
        this.name = name;
        this.main = main;
        this.module = module;
        ...
        this["direct-eval"] = direct_eval;
        this["source-map"] = source_map;
        ...
        this.headers = null;
        this.globals = null;
        this.direct_eval = true;
        this.source_map = false;
        this.imports = null;
        this.exports = null;
        Object.assign(this, loc);
       }
...
export function J2SDeclRest(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, alloc_policy) {
  if (!new.target) {
    return new J2SDeclRest({"loc": array2list(loc), "id": id, "_scmid": _scmid, "key": key, "writable": writable, "scope": scope, "usecnt": usecnt, "useinloop": useinloop, "escape": escape, "usage": usage, "binder": binder, "ctype": ctype, "utype": utype, "itype": itype, "vtype": vtype, "mtype": mtype, "irange": irange, "vrange": vrange, "hint": array2list(hint), "_export": _export, "optional": optional, "alloc_policy": alloc_policy});
  } else {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.export = _export;
        this.optional = optional;
        this["alloc-policy"] = typeof(alloc_policy) === 'symbol' ? alloc_policy.toString().slice(7,-1) : alloc_policy;
      } else {
        this._scmid = false;
        this.key = 2;
        this.writable = true;
...
export function J2SDeclArguments(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, alloc_policy, argid, mode, fun) {
  if (!new.target) {
    return new J2SDeclArguments({"loc": array2list(loc), "id": id, "_scmid": _scmid, "key": key, "writable": writable, "scope": scope, "usecnt": usecnt, "useinloop": useinloop, "escape": escape, "usage": usage, "binder": binder, "ctype": ctype, "utype": utype, "itype": itype, "vtype": vtype, "mtype": mtype, "irange": irange, "vrange": vrange, "hint": array2list(hint), "_export": _export, "optional": optional, "alloc_policy": alloc_policy, "argid": argid, "mode": mode, "fun": fun});
  } else {
...
export function J2SDeclFun(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, val, expression) {
  if (!new.target) {
    return new J2SDeclFun({"loc": array2list(loc), "id": id, "_scmid": _scmid, "key": key, "writable": writable, "scope": scope, "usecnt": usecnt, "useinloop": useinloop, "escape": escape, "usage": usage, "binder": binder, "ctype": ctype, "utype": utype, "itype": itype, "vtype": vtype, "mtype": mtype, "irange": irange, "vrange": vrange, "hint": array2list(hint), "_export": _export, "optional": optional, "val": val, "expression": expression});
  } else {
...
export function J2SDeclFunType(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, val, expression) {
  if (!new.target) {
...
export function J2SDeclSvc(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, val, expression) {
  if (!new.target) {
...
export function J2SDeclClass(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, val) {
  if (!new.target) {
...
export function J2SDeclExtern(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, val, bind, hidden_class, raise_on_write, sweepable, configurable) {
  if (!new.target) {
    return new J2SDeclExtern({"loc": array2list(loc), "id": id, "_scmid": _scmid, "key": key, "writable": writable, "scope": scope, "usecnt": usecnt, "useinloop": useinloop, "escape": escape, "usage": usage, "binder": binder, "ctype": ctype, "utype": utype, "itype": itype, "vtype": vtype, "mtype": mtype, "irange": irange, "vrange": vrange, "hint": array2list(hint), "_export": _export, "optional": optional, "val": val, "bind": bind, "hidden_class": hidden_class, "raise_on_write": raise_on_write, "sweepable": sweepable, "configurable": configurable});
  } else {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.val = val;
        this.bind = bind;
        this["hidden-class"] = hidden_class;
        this["raise-on-write"] = raise_on_write;
        ...
        this.optional = false;
        this.bind = false;
        this.hidden_class = true;
        this.raise_on_write = false;
...
export function J2SDeclImport(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional, alias, _import) {
  if (!new.target) {
    return new J2SDeclImport({"loc": array2list(loc), "id": id, "_scmid": _scmid, "key": key, "writable": writable, "scope": scope, "usecnt": usecnt, "useinloop": useinloop, "escape": escape, "usage": usage, "binder": binder, "ctype": ctype, "utype": utype, "itype": itype, "vtype": vtype, "mtype": mtype, "irange": irange, "vrange": vrange, "hint": array2list(hint), "_export": _export, "optional": optional, "alias": alias, "_import": _import});
  } else {
...
export function J2SDeclInterface(loc, id, _scmid, key, writable, scope, usecnt, useinloop, escape, usage, binder, ctype, utype, itype, vtype, mtype, irange, vrange, hint, _export, optional) {
  if (!new.target) {
...
export function J2SIfArgDefVal(loc, test, then, _else) {
  if (!new.target) {
    return new J2SIfArgDefVal({"loc": array2list(loc), "test": test, "then": then, "_else": _else});
  } else {
...
export function J2SIdStmt(loc, need_bind_exit_break, id) {
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        this.loc = loc;
        this["need-bind-exit-break"] = need_bind_exit_break;
        this.id = id;
      } else {
        this.need_bind_exit_break = true;
        this.id = undefined;
        Object.assign(this, loc);
       }
    }
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this["need-bind-exit-break"] = need_bind_exit_break;
        this.id = id;
        this["need-bind-exit-continue"] = need_bind_exit_continue;
        this.body = body;
      } else {
        this.need_bind_exit_break = true;
        this.id = undefined;
        this.need_bind_exit_continue = true;
        Object.assign(this, loc);
       }
    }
  }
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.mode = typeof(mode) === 'symbol' ? mode.toString().slice(7,-1) : mode;
        this.decl = decl;
        this["need-bind-exit-return"] = need_bind_exit_return;
        this["new-target"] = typeof(new_target) === 'symbol' ? new_target.toString().slice(7,-1) : new_target;
        this.vararg = vararg;
        ...
        this.mode = 'normal';
        this.decl = false;
        this.need_bind_exit_return = false;
        this.new_target = 'unknown';
        this.vararg = false;
        this.generator = false;
        this.optimize = true;
        this.thisp = false;
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.constrsize = constrsize;
        this.cmap = cmap;
        this["need-super-check"] = need_super_check;
        this["need-dead-zone-check"] = need_dead_zone_check;
        ...
        this.constrsize = 0;
        this.cmap = false;
        this.need_super_check = false;
        this.need_dead_zone_check = false;
  ...
  if (!new.target) {
    ...
    if (loc) {
      if (loc instanceof Cons) {
        ...
        this.hint = null;
        this.range = undefined;
        this.base = "/home2/serrano/hop/master/node_modules/hopc/node";
        Object.assign(this, loc);
       }
    }
  }
