...
/*    Last change :  Mon Jan 22 12:36:00 2024 (serrano)                */
   ...
   match(port, val, rule) {
	 ...
	 case "OTAG": {
	    ...
	    while (true) {
		  ...
		  this.pushNodeIgnore(makeDomCreate(tag, reverse$(attr), null, this.#lang, this.#conf));
	       } else if (obj !== ">") {
...
class AttrValLexer extends Lexer {
   ...
   match(port, val, rule) {
	 ...
	 case "$": {
	    return htmlParseDollar(port, {}, null);
	 }
	 case "~": {
