...
/*    Last change :  Fri Jan 19 18:18:49 2024 (serrano)                */
...
import { J2SNode, J2SString, J2SUndefined, J2SCall, J2SDataPropertyInit } from "./ast.mjs";
...
function htmlParseScript(port, conf, plugins) {
   ...
   console.error("SCRIPT=", port.buffer.substring(0, 40), conf);
