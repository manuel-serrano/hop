...
/*    Last change :  Mon Feb  5 07:46:45 2024 (serrano)                */
...
function htmlParseScriptHop(attributes, port, conf, plugins) {
   ...
   //const prefix = `~{ import * as hop from '${conf?.hopBase ?? "/hop"}/0)${base}/hop/hop-client.mjs'; hop.seed = ${conf.hopSeed};`;
   const prefix = `~{ import * as hop from '${conf?.hopBase ?? "/hop"}/0/hop-client.mjs';`;
