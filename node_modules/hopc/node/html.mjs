/*=====================================================================*/
/*    .../prgm/project/hop/3.7.x/node_modules/hopc/node/html.mjs       */
/*    -------------------------------------------------------------    */
/*    Author      :  manuel serrano                                    */
/*    Creation    :  Sun Sep 17 16:21:38 2023                          */
/*    Last change :  Wed Jan 31 16:13:02 2024 (serrano)                */
...
class XMLLexer extends Lexer {
   ...
   openTag(type, sym, attributes, port) {
	 ...
	 return this.pushNodeIgnore(node);
      } else if (prop && prop.script && javascriptTypeAttributep(attributes)) {
	 const tag = new Token(type, sym, makeLoc(port));
...
/*---------------------------------------------------------------------*/
/*    javascriptTypeAttributep ...                                     */
/*---------------------------------------------------------------------*/
function javascriptTypeAttributep(attributes) {
   const type = scriptType(attributes);
   return type === "javascript" || type === "module";
}
