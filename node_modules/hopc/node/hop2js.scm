;*=====================================================================*/
;*    .../prgm/project/hop/3.7.x/node_modules/hopc/node/hop2js.scm     */
;*    -------------------------------------------------------------    */
;*    Author      :  manuel serrano                                    */
;*    Creation    :  Wed Sep 13 01:56:26 2023                          */
;*    Last change :  Tue Nov 21 10:37:04 2023 (serrano)                */
...
(define string=-char=-expander
   (lambda (fun args env)
      (let ((lhs (hop2js-expr (car args) env))
	    (rhs (hop2js-expr (cadr args) env)))
	 (format "~a === ~a" lhs rhs))))
(hashtable-put! expander-table "string=?" and-or-expander)
(hashtable-put! expander-table "char=?" and-or-expander)
