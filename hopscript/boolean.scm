...
;*    Last change :  Fri Apr  5 08:07:41 2019 (serrano)                */
...
;*---------------------------------------------------------------------*/
;*    js-jsobject->obj ::JsBoolean ...                                 */
;*---------------------------------------------------------------------*/
(define-method (js-jsobject->obj obj::JsBoolean %this::JsGlobalObject)
   (with-access::JsBoolean obj (val)
      val))
