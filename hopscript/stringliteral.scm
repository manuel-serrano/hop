...
;*---------------------------------------------------------------------*/
(define-method (js-get-lengthu32 o::JsStringLiteralASCII cache %this)
...
(define (js-jsstring-maybe-indexof this search position %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call2 %this
	     (js-get-name/cache this 'indexOf (js-pcache-ref %pcache 1)  %this)
...
(define (js-jsstring-maybe-lastindexof this search position %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call2 %this
	     (js-get-name/cache this 'lastIndexOf (js-pcache-ref %pcache 2)  %this)
	     this search position))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-charcodeat this index %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call1 %this
	     (js-get-name/cache this 'charCodeAt (js-pcache-ref %pcache 3) %this)
	     this index))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-charat this index %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call1 %this
	     (js-get-name/cache this 'charAt (js-pcache-ref %pcache 4) %this)
	     this index))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-substring this start end %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call2 %this
	     (js-get-name/cache this 'substring (js-pcache-ref %pcache 5) %this)
	     this start end))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-substr this start length %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call2 %this
	     (js-get-name/cache this 'substr (js-pcache-ref %pcache 6) %this)
	     this start length))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-tolowercase this %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call0 %this
	     (js-get-name/cache this 'toLowerCase (js-pcache-ref %pcache 7) %this)
	     this))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-touppercase this %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call0 %this
	     (js-get-name/cache this 'toUpperCase (js-pcache-ref %pcache 9) %this)
	     this))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-split this separator limit %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call2 %this
	     (js-get-name/cache this 'split (js-pcache-ref %pcache 11)  %this)
		   ...
		   (else
		    (let ((newstring (js-tostring replacevalue %this)))
			  ...
			  (js-jsstring-append
			     ...
			     (js-substring/enc s (cdar r) (string-length s) enc))))))))
	    ((isa? replacevalue JsFunction)
...
(define (js-jsstring-replace this::obj searchvalue replacevalue %this)
	 ...
	 (let loop ((i 0)
		...
		(let ((segments (cons (substring fmt j i) segments)))
		   (case (string-ref fmt (+fx i 1))
		      ...
		      ((#\`)
		       (let* ((k (js-get-name/cache match 'index
   ...
   (with-access::JsGlobalObject %this (js-regexp js-array)
	 ...
	 (cond
	    ...
	    ((not (js-get-name/cache searchvalue 'global
		     (js-pcache-ref %pcache 14)
		      %this))
	     (let* ((proto (js-get-name/cache js-regexp 'prototype
			      (js-pcache-ref %pcache 15)
			       %this))
		...
		(cond
		   ((eq? res (js-null))
		    string)
		   ((isa? replacevalue JsFunction)
		    (let ((i (js-get-name/cache res 'index
...
(define (js-jsstring-maybe-replace this searchvalue replacevalue %this)
   (let loop ((this this))
      (cond
	 ((js-jsstring? this)
	  (if (isa? searchvalue JsRegExp)
	      (with-access::JsRegExp searchvalue (rx global lastindex)
		 (with-access::JsValueDescriptor lastindex ((lastindex value))
		    (with-access::JsValueDescriptor global ((global value))
		       (let ((res (js-jsstring-replace-regexp this rx
				     lastindex global
				     replacevalue %this)))
			  (when global (set! lastindex 0))
			  res))))
      ...
      (let* ((s (js-jsstring->string this))
	     ...
	     (proto (js-get-name/cache js-regexp 'prototype
		       (js-pcache-ref %pcache 24)
		        %this))
	     (exec (js-get-name/cache proto 'exec
		      (js-pcache-ref %pcache 25)
		       %this)))
	 (with-access::JsRegExp rx (lastindex global)
	    (with-access::JsValueDescriptor global ((global value))
	       (with-access::JsValueDescriptor lastindex ((lastindex value))
		  ;; 7
		  (if (not global)
...
(define (js-jsstring-maybe-match this regexp %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call1 %this
	     (js-get-name/cache this 'match (js-pcache-ref %pcache 26)  %this)
	     this regexp))
	 (else
	  (loop (js-toobject %this this))))))
...
(define (js-jsstring-maybe-trim this %this)
   (let loop ((this this))
	 ...
	 ((isa? this JsObject)
	  (js-call0 %this
	     (js-get-name/cache this 'trim (js-pcache-ref %pcache 29) %this)
	     this))
	 (else
	  (loop (js-toobject %this this))))))
