...
/*    Last change :  Thu Jul 18 08:01:43 2024 (serrano)                */
...
d = new Date(Date.UTC(2015, 9, 19, 12, 22, 44, 999));
assert.ok(d.getTime() === 1445257364999, "year+month+...+milli");

d = new Date(Date.UTC(2015, 9, 19, 12, 22, 44));
assert.ok(d.getTime() === 1445257364000, "year+month+...+seconds");

d = new Date(Date.UTC(2015, 9, 19, 12, 22));
assert.ok(d.getTime() === 1445257320000, "year+month+...+minutes");

d = new Date(Date.UTC(2015, 9, 19, 12));
assert.ok(d.getTime() === 1445256000000, "year+month+...+hours");

d = new Date(Date.UTC(2015, 9, 19));
assert.ok(d.getTime() === 1445212800000, "year+month+day");

d = new Date(Date.UTC(2015, 9));
assert.ok(d.getTime() === 1443657600000, "year+month");

d = new Date(Date.UTC(2015));
console.log(d.getTime());
assert.ok(d.getTime() === 1420070400000, "time");
